...
import { $ as $$Card } from './Card_qu9uer0n.mjs';
import { c as createSvgComponent } from './MainLayout_DNwEXvsv.mjs';
/* empty css                         */
...
}, "/Users/joaobarbosa/occulta-website/src/components/ui/ServiceCard.astro", void 0);
...
const c2 = new Proxy({"src":"/_astro/card-pic2.BeQ4x_k2.png","width":210,"height":148,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/joaobarbosa/occulta-website/src/assets/pics/card-pic2.png";
							}
...
const c3 = new Proxy({"src":"/_astro/card-pic3.D4d3JTsx.png","width":210,"height":210,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/joaobarbosa/occulta-website/src/assets/pics/card-pic3.png";
							}
...
const c4 = new Proxy({"src":"/_astro/card-pic4.CPZGvqT8.png","width":210,"height":194,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/joaobarbosa/occulta-website/src/assets/pics/card-pic4.png";
							}
...
const c5 = new Proxy({"src":"/_astro/card-pic5.CqK5dBMJ.png","width":210,"height":196,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/joaobarbosa/occulta-website/src/assets/pics/card-pic5.png";
							}
...
const c6 = new Proxy({"src":"/_astro/card-pic6.CXJkFMY0.png","width":210,"height":170,"format":"png"}, {
						get(target, name, receiver) {
							...
							if (name === 'fsPath') {
								return "/Users/joaobarbosa/occulta-website/src/assets/pics/card-pic6.png";
							}
